...
From 1998 the Foundation worked closely with the indecs project (1998-2000) and a number of subsequent and continuing initiatives building on this. The [indecs framework](/the-identifier/resources/factsheets/the-indecs-framework) underpins the DOI data model and also the Vocabulary Mapping Framework (VMF). IDF now hosts the VMF web site and participates in VMF governance; the IDF's data dictionary is a namespace within VMF.
...
Norman Paskin wrote a history/case study of DOI standardization, "[The Digital Object Identifier: From Ad Hoc to National to International](/static/resources/DOI_Case_Study_Paskin.pdf)" that was published in [The Critical Component: Standards in the Information Exchange Environment](http://www.alastore.ala.org/detail.aspx?ID=11483) (2015), edited by Todd Carpenter (ISBN13: 978-0-8389-8744-5) published by ALCTS (American Library Association Publishing). A PDF ebook (ISBN: 978-0-8389-8745-2) and EPUB (ISBN: 978-0-8389-8746-9) bundle are also available through the ALA Store online.
...
A re-sizable version of the DOI logo for Internet use under these conditions can be downloaded as a convenience for companies, organizations and the press. Inclusion of this logo should not be used to imply IDF's endorsement of the company, product or services.
...
Over the past decade, a number of reports were published quantifying or endorsing DOI benefits in various sectors, and discussing the need for persistent identifiers on networks. A selection is archived.
